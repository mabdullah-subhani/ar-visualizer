...
class OnBoardingNextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
        ...
        bottom: MyAppDeviceUtils.getBottomNavigationBarHeight(),
        child: ElevatedButton(onPressed: ()=> OnBoardingController.instance.nextPage(),
            style: ElevatedButton.styleFrom(shape: const CircleBorder(),backgroundColor: dark ? MyAppColors.darkSecondaryColor : MyAppColors.lightSecondaryColor,),
